...
with open('assets_gen/radhika-logo.svg', 'w') as f:
    f.write(logo_svg)
...
with open('assets_gen/radhika-profile.svg', 'w') as f:
    f.write(profile_svg)
...
with open('assets_gen/project-ecommerce.svg', 'w') as f:
    f.write(p1_svg)
...
with open('assets_gen/project-airline.svg', 'w') as f:
    f.write(p2_svg)
...
with open('assets_gen/project-gym.svg', 'w') as f:
    f.write(p3_svg)
...
with open('assets_gen/project-socialhub.svg', 'w') as f:
    f.write(p4_svg)
...
p5_svg = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 800" width="1200" height="800">
  ...
  <g transform="translate(100, 100)">
    ...
    <text x="0" y="125" font-family="'Inter', sans-serif" font-size="15" fill="#A3A3A3">Kotlin Android client backed by Firebase &amp; AI candidate match score.</text>
...
with open('assets_gen/project-aicruit.svg', 'w') as f:
    f.write(p5_svg)
...
with open('assets_gen/project-placeholder.svg', 'w') as f:
    f.write(placeholder_svg)

print("SVG templates generated in ./assets_gen successfully!")
